...
export function AnimatedModalResume({ text, icon }) {
  const images = [
  ...
  return (
    <div className="flex items-center justify-center">
      <Modal>
        <ModalTrigger className="bg-[#5fcfd3] text-black flex justify-center group/modal-btn px-5 py-3 rounded-xl border-2 border-white">
